  ...
  return (
    <div className={classes.contentWrapper}>
      ...
      {!tts.isSpeaking ? (
        ...
        <button className={classes.tts} title="Stop" onClick={stopHandler}>
